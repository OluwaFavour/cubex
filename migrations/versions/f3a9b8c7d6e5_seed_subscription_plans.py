...
CUBEX_API_PLANS = [
    ...
    },
    {
        ...
        "seat_price": Decimal("2.00"),
        "seat_display_price": "$2/seat/month",
        "seat_stripe_price_id": settings.STRIPE_CUBEX_API_SEAT_PRICE_BASIC,
        "is_active": True,
        "trial_days": 14,
        "type": "PAID",
        "product_type": "API",
    ...
    },
    {
        ...
        "seat_price": Decimal("4.00"),
        "seat_display_price": "$4/seat/month",
        "seat_stripe_price_id": settings.STRIPE_CUBEX_API_SEAT_PRICE_PROFESSIONAL,
        "is_active": True,
        "trial_days": 14,
        "type": "PAID",
        "product_type": "API",
...
def upgrade() -> None:
    ...
    plans_table = sa.table(
        ...
        sa.column("seat_price", sa.Numeric),
        sa.column("seat_display_price", sa.String),
        sa.column("seat_stripe_price_id", sa.String),
    ...
    for plan in all_plans:
        op.execute(
            plans_table.insert().values(
                ...
                seat_stripe_price_id=plan["seat_stripe_price_id"],

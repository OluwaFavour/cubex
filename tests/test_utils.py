...
class TestHmacHashOtp:
    ...
    def test_hmac_hash_otp_success(self):
        ...
        result = hmac_hash_otp(otp, secret)
    ...
    def test_hmac_hash_otp_deterministic(self):
        ...
        hash1 = hmac_hash_otp(otp, secret)
        hash2 = hmac_hash_otp(otp, secret)
    ...
    def test_hmac_hash_otp_different_otp(self):
        ...
        hash2 = hmac_hash_otp("654321", secret)
    ...
    def test_hmac_hash_otp_different_secret(self):
        ...
        hash2 = hmac_hash_otp(otp, "secret2")
...
class TestHmacVerifyOtp:
    ...
    def test_hmac_verify_otp_success(self):
        ...
        otp = "123456"
        secret = "test_secret_key"
        hashed = hmac_hash_otp(otp, secret)

        result = hmac_verify_otp(otp, hashed, secret)
        assert result is True
    ...
    def test_hmac_verify_otp_wrong_otp(self):
        ...
        result = hmac_verify_otp("654321", hashed, secret)
        assert result is False
    ...
    def test_hmac_verify_otp_wrong_secret(self):
        ...
        result = hmac_verify_otp(otp, hashed, "wrong_secret")
        assert result is False
    ...
    def test_hmac_verify_otp_tampered_hash(self):
        ...
        result = hmac_verify_otp(otp, tampered, secret)
        assert result is False
    ...
    def test_hmac_verify_otp_constant_time(self):
        ...
        otp = "123456"
        secret = "test_secret_key"
        correct_hash = hmac_hash_otp(otp, secret)
        wrong_hash = "a" * 64  # Completely wrong hash
        ...
        for _ in range(iterations):
            hmac_verify_otp(otp, correct_hash, secret)
        correct_time = time.perf_counter() - start

        start = time.perf_counter()
        for _ in range(iterations):
            hmac_verify_otp(otp, wrong_hash, secret)
